...
public class StringManipulations {
    ...
    String str ="I like to learn Java. I like to watch the mivie Jumanji";

    int a1 = str.indexOf("J"); // returns the index number of first matching one'
