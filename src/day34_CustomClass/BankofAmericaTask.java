...
*/
    public static void main(String[] args) {
        ArrayList<TesterTask> AutomationTeam = new ArrayList<>();

        TesterTask tester1 = new TesterTask();
        tester1.setTestersInfo("Zuura Idrisova", 90123, "SDET", 100000);

        TesterTask tester2 = new TesterTask();
        tester2.setTestersInfo("Kim Hua", 90234, "QA", 67000);

        TesterTask tester3 = new TesterTask();
        ...
        Predicate<TesterTask> manual = p -> p.jobTitle.equals("Manual tester");
